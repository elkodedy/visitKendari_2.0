      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Tour Accomodation</h1>
            <p class="breadcrumbs"><span class="mr-2">Break Makes You Live Longer</span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate order-md-last">
            <?php $i=1; foreach($acc_1 as $row_1){} ?>
            <p>
              <img src="<?php echo base_url().$row_1->acc_photo ?>" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3"><?php echo $row_1->acc_name ?></h2>
            <p>
              <?php echo $row_1->acc_info ?>
            </p>
            <p class="text-center"><a href="#" class="btn btn-primary px-5 py-3">Go Now <?php echo $row_1->acc_cost ?></a></p>
            ...
            <div class="ftco-search">
              <div class="nav-link-wrap">
                <div class="nav nav-pills d-flex text-center justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link ftco-animate active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Accommodations</a>
                </div>
              </div>
            </div>
          </div>
	              ...
	              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                    ...
                    <div class="col-lg-12 d-flex sidebar mt-3">
                      <div class="menus d-sm-flex ftco-animate">
                        <div class="menu-img img" style="background-image: url(<?php echo base_url().$row->acc_photo?>);"></div>
                        <div class="text d-flex align-items-center">
                          <div>
                            <div class="d-flex">
                              <div class="one-half">
                                <h3><?php echo $row->acc_name ?></h3>
                              </div>
                            </div>
