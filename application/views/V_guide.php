      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Our Guide</h1>
            <p class="breadcrumbs"><span class="mr-2">Guide Makes You Live Easier</span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate order-md-last">
            <?php $i=1; foreach($gui_1 as $row_1){} ?>
            <p>
              <img src="<?php echo base_url().$row_1->guide_photo ?>" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3"><?php echo $row_1->guide_name ?></h2>
            <p>
              <?php echo $row_1->guide_info ?>
            </p>
            <p class="text-center"><a href="#" class="btn btn-primary px-5 py-3">Go Now <?php echo $row_1->guide_cost ?></a></p>
            ...
            <div class="ftco-search">
              <div class="nav-link-wrap">
                <div class="nav nav-pills d-flex text-center justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link ftco-animate active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Guides</a>
                </div>
              </div>
            </div>
          </div>
	              ...
	              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                    ...
                    <div class="col-lg-12 d-flex sidebar mt-3">
                      <div class="menus d-sm-flex ftco-animate">
                        <div class="menu-img img" style="background-image: url(<?php echo base_url().$row->guide_photo?>);"></div>
